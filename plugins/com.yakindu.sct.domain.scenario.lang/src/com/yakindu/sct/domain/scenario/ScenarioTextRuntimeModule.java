...
public class ScenarioTextRuntimeModule extends AbstractScenarioTextRuntimeModule {

	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME))
				.toInstance("com.yakindu.sct.domain.scenario.ScenarioText");
		binder.bind(String.class).annotatedWith(Names.named(DomainRegistry.DOMAIN_ID))
		.toInstance("com.yakindu.domain.scenario");
	}
